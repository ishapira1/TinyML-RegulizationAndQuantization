...
if __name__ == '__main__':
    ...
    batch_size = 256
    lr = 0.001
    DATASETS = ['FashionMNIST'] #['CIFAR-10', 'MNIST', 'ImageNet', 'FASHIONMNIST']
    ...
    REGULARIZATIONS = {
        ...
        'l1': [0.0001,0.0002,0.0003,0.0004,0.0005,0.0006,0.0007,0.0008,0.0009,0.001,0.005],  # Different L1 regularization strengths
        'l2': [0.0001,0.0002,0.0003,0.0004,0.0005,0.0006,0.0007,0.0008,0.0009,0.001],  # Different L2 regularization strengths
